...
public class LinkedListTest {
    ...
    public static void main(String[] args) {
        ...
        int mark = 0;
        String report = new String("Failed test(s):\n");
        ...
        int mark_Node_Class = 0;
        try
        {
            mark_Node_Class = test_Node_Class();
        }
        catch(Exception e)
        {
            System.out.println(ANSI_RED+e+ANSI_RESET);
        }
        mark += mark_Node_Class;
        if(mark_Node_Class < 5)
        {
            report += ANSI_RED+"test_test_Node_Class()\n"+ANSI_RESET;
        }
        System.out.println("Current mark: " + mark);
        System.out.println();
    ...
    private static int test_Node_Class()
    {
        System.out.println("Testing for \"Node Class\" methods (mark: 5)");
        int mark = 0;
